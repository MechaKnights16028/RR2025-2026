...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 1828.228026809831; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -2085.0402233951563; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -2185.403354738762; // x position of the perpendicular encoder (in tick units)
    }
